            ...
            <div class="header-main-wrapper">
                <nav class="header-main-nav">
                    <ul>
                        ...
                        <li><a class="header-main-nav__link header-main-nav__link--active" href="contacts.html">Контакты</a></li>
                    </ul>
                </nav>
            ...
            <div class="add-question-wrapper">
                <div class="contact-contain-photo">
                    ...
                    <div class="contact-contain-photo__wrapper">
                        <img src="img/section/contact/photo1.webp" alt="">
                        <img src="img/section/contact/photo2.webp" alt="">
                    </div>
                </div>
