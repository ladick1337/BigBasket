	...
	$.fn.redCountdown = function(Options, Callback) {
		...
		function getPreset(presetName) {
			switch (presetName) {
                ...
                case 'custom': return {labels:true,style:{element:"",textResponsive:.5,daysElement:{gauge:{thickness:.03,bgColor:"rgba(0,0,0,0.05)",fgColor:"#2FB0E4"},textCSS:'color:#34495e;'},hoursElement:{gauge:{thickness:.03,bgColor:"rgba(0,0,0,0.05)",fgColor:"#2FB0E4"},textCSS:'color:#34495e;'},minutesElement:{gauge:{thickness:.03,bgColor:"rgba(0,0,0,0.05)",fgColor:"#2FB0E4"},textCSS:'color:#34495e;'},secondsElement:{gauge:{thickness:.03,bgColor:"rgba(0,0,0,0.05)",fgColor:"#2FB0E4"},textCSS:'color:#34495e;'}}};
			}
		}
